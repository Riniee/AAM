					...
					<div class="wrapper-inner">
                        ...
                        <div class="filter-section">
                            <ul>
                                ...
                                <li><div class="button-wrapper"><i class="fa fa-filter" style="color:#1d5592;"></i></div></li>
                                <li><div class="button-wrapper"><i class="fa fa-ban" style="color:#b94260;"></i></div></li>
                                <li><div class="button-wrapper"><i class="fa fa-list-ul" style="color:#545454;"></i></div></li>
                            </ul>
                        </div>                    
						-->
