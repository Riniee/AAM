        ...
        <section id="prototype_table1">
            <div class="container-fluid">
                <div class="row header-div">
                    <div class="col-md-6 col-sm-6 header-lft"> <img src="assets/images/AAM.jpg" alt="aam">
                    ...
                    <div class="col-md-6 col-sm-6 header-rtl">
                        ...
                        <p><strong>Annual Frequency:</strong><?php echo $lheader['FREQUENCY'] ?></p>
                        <p><strong>Field Served:</strong> <?php echo $lheader['FIELD_SERVED'] ?></p>
                        <h5><?php echo $lheader['PUBLISHED_BY'] ?></h5> </div>
                </div>
            </div>
            <div class="container-fluid">
                    ...
                    <div class="table-responsive">
                        <table class="table">
							...
							?>
								<tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['ISSUE_NAME'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['PAID_SUBS_PRINT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['PAID_SUBS_DIGIT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> >
										<?php echo $row['SUBSCRIPTION_COUNT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> >
										<?php echo $row['VERIF_SUBS_PRINT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> >
										<?php echo $row['VERIF_SUBS_DIGIT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['VERIF_SUBS'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['TOTAL_PAID_VERIF_SUBS'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['SCS_PRINT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['SCS_DIGIT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> ><?php echo $row['SINGLE_COPY_COUNT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> >
										<?php echo $row['TOTAL_PAID_VERIF_CIRC_PRINT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> >
										<?php echo $row['TOTAL_PAID_VERIF_CIRC_DIGIT'] ?></td>
                                    <td <?php if(isset($tcibold)) { ?> class="tb" <?php } ?> >
										<?php echo $row['TOTAL_PAID_VERIF_CIRC'] ?></td>
                                </tr>
							<?php } ?>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>	
									<?php if ($psdata) { ?>
										<tr>
											<th class="blue-light-clr p0" colspan="5">Paid Subscriptions</th>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_PD_ASSOC_SUBS_DED_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_ASSOC_SUBS_DED'] ?></td>
										...
										<tr>
										   ...
										   <td><?php echo $sa['PARA_6_PD_ASSOC_SUBS_ND_PRINT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_ASSOC_SUBS_ND_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_ASSOC_SUBS_ND'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_PD_CLUB_MEMBR_DED_DIGIT'] ?></td>						
											<td><?php echo $sa['PARA_6_PD_CLUB_MEMBER_DED'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_PD_CLUB_MEMBR_ND_DIGIT'] ?></td>							
											<td><?php echo $sa['PARA_6_PD_CLUB_MEMBER_ND'] ?></td>
											<td><?php echo $sa['PARA_6_PD_CLUB_MEMBER_ND_PCT'] ?></td>
										</tr>
										<tr>
											<td class="taj pr4">Deferred</td>
											<td><?php echo $sa['PARA_6_PD_DEFER_SUBS_PRINT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_DEFER_SUBS_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_DEFER_SUBS'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_PD_PRTNR_SUBS_DED_DIGIT'] ?></td>						
											<td><?php echo $sa['PARA_6_PD_PARTNER_SUBS_DED'] ?></td>
											<td><?php echo $sa['PARA_6_PD_PARTNER_SUBS_DED_PCT'] ?></td>
										</tr>
										<tr>
											<td class="taj pr4">School</td>
											<td><?php echo $sa['PARA_6_PD_SCHOOL_PRINT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_SCHOOL_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_SCHOOL_SUBS'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_PD_SPONS_SALES_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_PD_SPONS_SALES'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_TOTAL_PAID_SUBS_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_TOTAL_PAID_SUBS'] ?></td>
									...
									<?php if ($vsdata) { ?>
										<tr>
											<th class="blue-light-clr p0" colspan="5">Verified Subscriptions</th>
										</tr>
										<tr>
											<td class="taj pr4">Public Place</td>
											<td><?php echo $sa['PARA_6_VERIF_SUBS_PP_PRINT'] ?></td>
											<td><?php echo $sa['PARA_6_VERIF_SUBS_PP_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_VERIF_SUBS_PUBL_PL'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_VERIF_SUBS_IU_DIGIT'] ?></td>								
											<td><?php echo $sa['PARA_6_VERIF_SUBS_IND_USE'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_TOT_VERIF_SUBS_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_TOTAL_VERIF_SUBS'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_TOT_PD_VERIF_SUBS_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_TOTAL_PD_VERIF_SUBS'] ?></td>
											<td><?php echo $sa['PARA_6_TOTAL_PD_VERIF_SUBS_PCT'] ?></td>
										</tr>
									<?php } ?>
									<?php if ($scsdata) { ?>
										<tr>
											<th class="blue-light-clr p0" colspan="5">Single Copy Sales</th>
										</tr>
										<tr>
											<td class="taj pr4">Single Issue</td>
											<td><?php echo $sa['PARA_6_SCS_PRINT'] ?></td>
											<td><?php echo $sa['PARA_6_SCS_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_SINGLE_ISSUE_SALES'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_SCS_PARTNER_DED_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_SCS_PARTNERSHIP_DED'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_SCS_SPONS_SALES_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_SCS_SPONS_SALES'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_TOTAL_SCS_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_TOTAL_SCS'] ?></td>
										...
										<tr>
											...
											<td><?php echo $sa['PARA_6_TOT_PD_VERIF_CIRC_DIGIT'] ?></td>
											<td><?php echo $sa['PARA_6_TOTAL_PD_VERIF_CIRC'] ?></td>
                        ...
                        <div class="table-responsive">
                            <table class="table">
								...
								<?php if ($paav) { ?>
									...
									?>
                                    <tr>
                                        <td <?php if (isset($paavbold)) { ?> class="taj pr4 tb"	<?php } else { ?> class="taj pr4"
											<?php } ?> ><?php echo $row['DESCRIPTION']; ?></td>
                                        <td><?php echo $row['MAVS_VERIF_SUBS_PRINT']; ?></td>
                                        <td><?php echo $row['MAVS_VERIF_SUBS_DIGIT']; ?></td>
                                        <td><?php echo $row['MAVS_VERIF_SUBS']; ?></td>
                                    </tr>
									<?php } ?>                                    
								<?php } ?>   
								<?php if ($iaav) { ?>
									...
									?>
                                    <tr>
                                        <td <?php if (isset($iaavbold)) { ?> class="taj pr4 tb"	<?php } else { ?> class="taj pr4"
											<?php } ?> ><?php echo $row['DESCRIPTION']; ?></td>
                                        <td><?php echo $row['MAVS_VERIF_SUBS_PRINT']; ?></td>
                                        <td><?php echo $row['MAVS_VERIF_SUBS_DIGIT']; ?></td>
                                        <td><?php echo $row['MAVS_VERIF_SUBS']; ?></td>
                    ...
                    <div class="col-md-6 col-sm-12 p0">
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-md-10">
                                <p><strong>Award Point Subscriptions:</strong> Included in Paid Subscriptions Individual is the following average number of copies purchased through the redemption of award points: 10, 450</p>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="taj pl4">Parent Company:
                                                <br>PUB NAME, published by Publisher Address City,ST ZIP</p>
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6">
                                                        <p class="taj p0">NAME</p>
                                                        <p class="taj p0">Director</p>
                                                        <p class="taj p0">Date Signed:</p>
                                                        <p class="taj p0">T: 000.000.1000 • F: 000.000.0000 • URL: www.</p>
                                                        <p class="taj p0">Established:</p>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 ">
                                                        <p class="taj p0">NAME</p>
                                                        <p class="taj p0">Publisher</p>
                                                        <p class="taj p0">Sales Offices:</p>
                                                        <p class="taj p0">&nbsp;</p>
                                                        <p class="taj p0">AAM Member since:</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
