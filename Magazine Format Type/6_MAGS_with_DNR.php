                    ...
                    <div class="col-md-12 col-sm-12 p0">
                        ...
                        <div class="table-responsive">
                            <table class="table">
								...
								foreach ($es as $row) { ?>
                                    <tr>
                                        <td class="tb"><?php echo $row['PARA_1_PAID_VERIF_SUBS'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_SCS'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_PAID_VERIF_CIRC'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_TOTAL_ANP_CIRC'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_PAID_VERIF_ANP_CIRC'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_TOTL_RB'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_TOTL_VARIANCE_RB'] ?></td>
                                    </tr>
									<?php		
								}
							?>
                    ...
                    <div class="col-md-8 col-sm-8 p0">
                        ...
                        <div class="table-responsive">
                            <table class="table">
								...
								foreach ($es as $row) { ?>
                                    <tr>
                                        <td class="tb"><?php echo $row['PAR_1_DIGIT_NR_PD_VER_SUBS'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_DIGIT_NON_REPL_SCS'] ?></td>
                                        <td class="tb"><?php echo $row['PAR_1_DIGIT_NR_PD_VER_CIRC'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_DIGIT_NON_REPL_ANP'] ?></td>
                                        <td class="tb"><?php echo $row['PARA_1_DIGIT_NON_REPL_TOTAL'] ?></td>
                                    </tr>
									<?php		
								}
							?>
                ...
                <div class="row magazine-table-div">
                    ...
                    <div class="table-responsive">
                        <table class="table">
							...
							?>
                                <tr>
									<td <?php if(isset($tcibolddn)) { ?> class="tb"
										<?php } ?> >
										<?php echo $row['SPECIAL_ISSUE'] ?>
									</td>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
									<?php if ($psdata) { ?>
									 <tr>
                                        <th class="blue-light-clr p0" colspan="4">Paid Subscriptions</th>
                                    </tr>
									...
									<tr>
										...
										<td class="tb"><?php echo $sa['PARA_6_TOTAL_PAID_SUBS_PRINT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOTAL_PAID_SUBS_PCT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOTAL_PAID_SUBS_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
							<?php } ?>
									...
									<tr>
										...
										<td class="tb"><?php echo $sa['PARA_6_TOT_PD_VERIF_SUBS_PRINT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOTAL_PD_VERIF_SUBS_PCT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOT_PD_VER_SUBS_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
								<?php } ?>
									...
									<tr>
										...
										<td class="tb"><?php echo $sa['PARA_6_TOT_PD_VERIF_CIRC_PRINT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOTAL_PD_VERIF_CIRC_PCT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOT_PD_VER_CIRC_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
								<?php } ?>
									...
									<?php if ($andata) { ?>
									<tr>
										<th class="blue-light-clr p0" colspan="4">Analyzed Nonpaid</th>
									</tr>									
									<?php if ($sa['PARA_6_ANP_LIST_SOURCE_PRINT']) { ?>
									<tr>
										<td class="taj pr4">List</td>
										<td><?php echo $sa['PARA_6_ANP_LIST_SOURCE_PRINT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_LIST_SOURCE_PCT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_LIST_SOURCE_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
									<?php if ($sa['PARA_6_ANP_MKT_COV_PRINT']) { ?>
									<tr>
										<td class="taj pr4">Market Coverage</td>
										<td><?php echo $sa['PARA_6_ANP_MKT_COV_PRINT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_MKT_COV_PCT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_MKT_COV_DIGIT_NR'] ?></td>
									</tr>
									<?php } ?>
									<?php if ($sa['PARA_6_ANP_BULK_PRINT']) { ?>
									<tr>
										<td class="taj pr4">Nonpaid Bulk</td>
										<td><?php echo $sa['PARA_6_ANP_BULK_PRINT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_BULK_PCT'] ?></td>
										<td><?php echo $sa['para_6_anp_bulk_dig_nr'] ?></td>
									</tr>
									<?php } ?>
									<?php if ($sa['PARA_6_ANP_DEL_HOST_PROD_PRINT']) { ?>
									<tr>
										<td class="taj pr4 tb">Delivered with Host Product</td>
										<td><?php echo $sa['PARA_6_ANP_DEL_HOST_PROD_PRINT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_DEL_HOST_PROD_PCT'] ?></td>
										<td><?php echo $sa['PARA_6_ANP_DEL_HOST_PRD_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
									<?php if ($sa['PARA_6_TOTAL_ANP_PRINT']) { ?>
									<tr>
										<td class="taj pr4 tb">Total Analyzed Nonpaid</td>
										<td><?php echo $sa['PARA_6_TOTAL_ANP_PRINT'] ?></td>
										<td><?php echo $sa['PARA_6_TOTAL_ANP_PCT'] ?></td>
										<td><?php echo $sa['PARA_6_TOTAL_ANP_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
									<?php if ($sa['PARA_6_TOT_PD_VERIF_ANP_PRINT']) { ?>
									<tr>
										<td class="taj pr4 tb">Total Circulation</td>
										<td class="tb"><?php echo $sa['PARA_6_TOT_PD_VERIF_ANP_PRINT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOTAL_PD_VERIF_ANP_PCT'] ?></td>
										<td class="tb"><?php echo $sa['PARA_6_TOT_PD_VERIF_ANP_DIG_NR'] ?></td>
									</tr>
									<?php } ?>
								<?php } ?>
                                </tbody>
                    ...
                    <div class="col-md-6 col-sm-12 p0">
                        ...
                        <div class="table-responsive">
                            <table class="table">
								...
								?>
									<tr>
										<td class="taj pr4 tb">Average Single Copy</td>
										<td>$
											<?php echo $asc; ?>
										</td>
										<td rowspan="2">&nbsp;</td>
									...
									<tr>
										<td class="taj pr4 tb">Subscription</td>
										<td>$
											<?php echo $subscription; ?>
										</td>
									</tr>
									<tr>
										<td class="taj pr4 tb">Average Subscription Price Annualized (3)</td>
										<td rowspan="2">&nbsp;</td>
										<td>$
											<?php echo $aspa1net; ?>
										</td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p class="taj pl4">Parent Company:
                                                    <br>PUB NAME, published by Publisher Address City, PROV PC</p>
                                                <div class="container-fluid">
                                                    <div class="row">
