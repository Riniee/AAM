...
$pdf->SetTitle('11 MGNS print digital');
$pdf->SetSubject('11 MGNS print digital');
$pdf->SetKeywords('PDF,11 MGNS print digital');
...
$title_3 = table_cell('  PRICE');
$title_4 = table_cell('  RATE BASE');
$title_5 = table_cell('  NOTES');
/* Setting up the Title */
...
if($es) {
    ...
    foreach($es as $res) {
        $data .= '<tr align="center">
                <td border="1">'. number_format($res['PARA_1_PAID_VERIF_SUBS']) .'</td>
                <td border="1">'. number_format($res['PARA_1_SCS']) .'</td>
                <td border="1">'. number_format($res['PARA_1_TOTAL_ANP_CIRC']) .'</td>
                <td border="1">'. number_format($res['PARA_1_PAID_VERIF_ANP_CIRC']) .'</td>
                <td border="1">'. number_format($res['PARA_1_TOTL_VARIANCE_RB']) .'</td>
                <td border="1">'. number_format($res['PARA_1_TOTL_VARIANCE_RB']) .'</td>
                <td border="1">'. number_format($res['PARA_1_PAID_VERIF_CIRC']) .'</td>
            </tr>';	
...
$Executive_Summary = '<table width="100%" border="1">
				<thead>
				 <tr align="center" style="background-color:#bcd4ee;color:#1a1a1a;">
...
if($tci) {
    ...
    for ($i=0; $i<$len-1; $i++) {
	    ...
	    $data .= '<tr align="center">
                     ...
                     <td border="1">' . number_format($row['PAID_SUBS_DIGIT']) . '</td>
                     <td border="1">' . number_format($row['SUBSCRIPTION_COUNT']) . '</td>
                     <td border="1">' . number_format($row['VERIF_SUBS_PRINT']). '</td>
                     <td border="1">' . number_format($row['VERIF_SUBS_DIGIT']) . '</td>
                     <td border="1">' . number_format($row['VERIF_SUBS']) . '</td>                     
                     <td border="1">' . number_format($row['TOTAL_PAID_VERIF_SUBS_PRINT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VERIF_SUBS_DIGIT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VERIF_SUBS']) . '</td>
                     <td border="1">' . number_format($row['SCS_PRINT']) . '</td>
                     <td border="1">' . number_format($row['SCS_DIGIT']) . '</td>
                     <td border="1">' . number_format($row['SINGLE_COPY_COUNT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VERIF_CIRC_PRINT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VERIF_CIRC_DIGIT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VERIF_CIRC']) . '</td>
                     <td border="1">' . number_format($row['ANP_PRINT']) . '</td>
                     <td border="1">' . number_format($row['ANP_DIGIT']) . '</td>
                     <td border="1">' . number_format($row['ANP_COUNT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VER_ANP_CIRC_PRINT']) . '</td>
                     <td border="1">' . number_format($row['TOTAL_PAID_VER_ANP_CIRC_DIGIT']) . '</td>
    ...
    for ($i=$len-1; $i<=$len-1; $i++) {
        $row = $tci[$i];
        $avg .= '<tr  align="center" style="font-weight:bold;">
                     <td border="1">' . $row['SPECIAL_ISSUE'] . '</td>
                     <td border="1">' . $row['ISSUE_NAME'] . '</td>
                     <td border="1">' . number_format($row['PAID_SUBS_PRINT']) . '</td>
                     <td border="1">' . number_format($row['PAID_SUBS_DIGIT']) . '</td>
...
$Total_Circulation = '<table width="100%" border="0">
					<thead>
						<tr>
							<th border="none" colspan="2" width="8.5%" align="center"></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" colspan="3"><b>Paid Subscriptions</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" colspan="3"><b>Verified Subscriptions</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Paid & Verified<br>Subscriptions<br>- Print</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Paid & Verified<br>Subscriptions -<br>Digital Issue</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total<br>Paid & Verified<br>Subscriptions</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" colspan="3"><b>Single Copy Sales</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total<br>Paid & Verified<br>Circulation - Print</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total<br>Paid & Verified<br>Circulation<br>- Digital Issue</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total<br>Paid & Verified<br> Circulation</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" colspan="3"><b>Analyzed Nonpaid</b></th>
							<th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total Paid, Verified & Analyzed Nonpaid Circulation - Print</b></th>
				            <th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total Paid, Verified & Analyzed Nonpaid Circulation - Digital Issue</b></th>
                            <th border="1"  style="background-color:#bcd4ee;color:#1a1a1a;" align="center" rowspan="2"><b>Total Paid, Verified & Analyzed NonpaidIssue Print Circulation</b></th>
							</tr>
							<tr style="background-color:#bcd4ee;color:#1a1a1a;">
								<th border="1" align="center" colspan="2"><b><br><br><br>Issue</b></th>
								<th border="1" align="center"><b><br><br><br>Print</b></th>
								<th border="1" align="center"><b><br><br>Digital<br>Issue</b></th>
								<th border="1"  align="center"><b><br>Total<br>Paid<br>Subscriptions</b></th>
								<th border="1" align="center"><b><br><br><br>Print</b></th>
								<th border="1" align="center"><b><br><br>Digital<br>Issue</b></th>
								<th border="1" align="center"><b><br>Total<br>Verified<br>Subscriptions</b></th>
								<th border="1" align="center"><b>Print</b></th>
								<th border="1"  align="center"><b>Digital<br>Issue</b></th>
								<th border="1" align="center"><b>Total<br>Single Copy<br>Sales</b></th>
								<th border="1" align="center"><b>Print</b></th>
								<th border="1" align="center"><b>Digital<br>Issue</b></th>
								<th border="1" align="center"><b>Total<br>Analyzed<br>Nonpaid</b></th>
							</tr>
							</thead>' . $data . ''.$avg.'													
						</table>';
...
$Prices ='<table width="100%" cellpadding="0" border="0">	
		<thead>
			<tr>
				<td width="65%"></td>		
				<td width="35%"style="background-color: #bcd4ee;color:#1a1a1a;" align="center" border="1"><b>Suggested<br>Retail Prices (1)</b></td>				
			</tr>
		</thead>'. $data .' 
	</table>';  
