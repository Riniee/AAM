...
$pdf->SetTitle('8 MGN print digital');
$pdf->SetSubject('8 MGN print digital');
$pdf->SetKeywords('PDF,8 MGN print digital');
...
if($es) {
    ...
    foreach($es as $row) {
        $data .= '<tr align="center">
                ...
                <td border="1">'. number_format($row['PARA_1_TOTL_RB']) .'</td>
                <td border="1">'. number_format($row['PARA_1_TOTL_VARIANCE_RB']) .'</td>            
            </tr>';	
    }

}
$Executive_Summary = '<table width="100%" align="center" border="1">
				<thead>
...
$Total_Circulation =
    '<table width="100%" border="0">
				<thead >
					<tr>
						<th  border="none" colspan="2" width="11.5%" ></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" colspan="3"><b>Paid Subscriptions</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" colspan="3"><b>Verified Subscriptions</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" rowspan="2"><b><br>Paid & Verified<br>Subscriptions<br>- Print</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" rowspan="2"><b><br>Paid & Verified<br>Subscriptions -<br>Digital Issue</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" rowspan="2"><b><br>Total<br>Paid & Verified<br>Subscriptions</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" colspan="3"><b>Single Copy Sales</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" rowspan="2"><b>Total<br>Paid & Verified<br>Circulation - Print</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" rowspan="2"><b>Total<br>Paid & Verified<br>Circulation<br>- Digital Issue</b></th>
						<th style="background-color:#bcd4ee;color:#1a1a1a;" border="1" align="center" rowspan="2"><b><br>Total<br>Paid & Verified<br> Circulation</b></th>
					</tr>
					<tr style="background-color:#bcd4ee;color:#1a1a1a;">
                        <th border="1" align="center" colspan="2"><b><br><br>Issue</b></th>
                        <th border="1" align="center"><b><br><br>Print</b></th>
                        <th border="1" align="center"><b><br>Digital<br>Issue</b></th>
				        <th border="1" align="center"><b>Total<br>Paid<br>Subscriptions</b></th>
						<th border="1" align="center"><b><br><br>Print</b></th>
						<th border="1" align="center"><b><br>Digital<br>Issue</b></th>
						<th border="1" align="center"><b>Total<br>Verified<br>Subscriptions</b></th>
						<th border="1" align="center"><b><br><br>Print</b></th>
						<th border="1" align="center"><b><br>Digital<br>Issue</b></th>
...
$Notes = 
    '<table width="100%" align="left" border="0">       
         <tr>
            <td style="color:#000;"><b>Included in Paid Circulation are copies obtained through individual subscriptions, sponsorship sale subscriptions
and single copy sales.</b></td>
         ...
         <tr>
            <td style="color:#000;"><b>Included in Verified Circulation are copies distributed to individually addressed.</b></td>
         </tr>
         <tr>
            <td></td>
		</tr>
         <tr>
            <td style="color:#000;"><b>* Special issue circulation not included in averages.</b></td>           
         </tr>         
    </table>';
