...
$pdf->SetTitle('17 CNTN print digital');
$pdf->SetSubject('TcPdf');
$pdf->SetKeywords('PDF,17 CNTN print digital');
    ...
    for ($i=0; $i<$len-1; $i++) {
        ...
        $data.= 
            '<tr>
                ...
                <td border="1" width="10%">'.$row['NPC_ISSUE_NAME'].'</td>
                <td border="1" width="25%">'.number_format($row['NPC_TOTAL_ANP_PRINT']).'</td>
                <td border="1" width="30%">'.number_format($row['NPC_TOTAL_ANP_DIG_REPL']).'</td>
                <td border="1" width="30%">'.number_format($row['NPC_TOTAL_ANP']).'</td>
            </tr>';
    }
...
$Total_Circulation = 
    '<table align="center" width="90%">
        <thead>
            <tr>
                <td width="15%" border="none"></td>
				<td border="1" width="85%" colspan="3" style="background-color: #bcd4ee;"><b>Analyzed Nonpaid</b></td>
            </tr>
            <tr>
