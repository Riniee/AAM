...
$pdf->SetTitle('7 MGN print only');
$pdf->SetSubject('7 MGN print only');
$pdf->SetKeywords('PDF, 7 MGN print only');
...
function table_cell($title){    
    ...
    <table width="100%">
        <tr>
            <td style="color:#fff; background-color:#0244A1;"><b>'.$title.'</b></td>
        </tr>
    ...
    '<table width="100%" border="1">
	   <thead>
		 <tr style="background-color:#bcd4ee;color:#1a1a1a;">
		  ...
		  <td align="center"><b><br>Single Copy<br>Sales</b></td>
		  <td align="center"><b><br>Total<br>Circulation</b></td>
		  <td align="center"><b><br>Rate<br>Base</b></td>
		  <td align="center"><b><br>Variance<br>to Rate Base</b></td>
		 </tr>
		</thead>'.$data.'
	</table>';
...
$Total_Circulation = '
        <table width="100%" border="0">
            <thead>
                <tr>
                    <td width="10%" ></td>
                    <td border="1" width="90%" align="center" 	color="#000" style="background-color: #bcd4ee;"><b>Print</b></td>
                </tr>
                <tr style="background-color: #bcd4ee;color:#1a1a1a;">
                    <td border="1" width="10%" align="center" colspan="2"><b><br><br>Issue</b></td>
                    <td border="1" width="15%" align="center"><b><br>Paid <br>Subscriptions</b></td>
                    <td border="1" width="15%" align="center"><b><br>Verified <br>Subscriptions</b></td>
                    <td border="1" width="20%" align="center"><b>Total<br>Paid & Verified<br>Subscriptions</b></td>
                    <td border="1" width="20%" align="center"><b><br>Single Copy <br>Sales</b></td>
                    <td border="1" width="20%" align="center"><b>Total<br> Paid & Verified<br>Circulation</b></td>
                </tr>
            </thead>' . $data . ''.$avg.'
        </table>';
