...
$pdf->SetTitle('13_CNTL_print_only');
...
function table_cell($title) {
    ...
    <table width="100%">
        <tr>
            <td style="color:#fff; background-color:#0f4a9e"><b>'.$title.'</b></td>
        </tr>
    ...
    '<table align="center" width="100%">
                <thead>
                    <tr>
				        ...
				        <td border="1" width="60%" colspan="3" style="background-color: #bcd4ee;"><b>Print</b></td>
                    </tr>
                     <tr >
                         <td border="1" width="5%" style="background-color: #bcd4ee;"></td>
                          <td border="1" width="35%" style="background-color: #bcd4ee;"><b><br><br>Issue</b></td>
...
if($sup) {
    ...
    $data = '';    
        $data .= '
            <tr>
			   <td border="1" width="50%" align="left">  List</td>
			   <td border="1" width="25%">' . number_format($sup['NP_PARA_1_LIST_PRINT']) . '</td>
               <td border="1" width="25%">' . number_format($sup['NP_PARA_1_LIST_SOURCE_PCT']) . '</td>
            </tr>
            <tr>
			   <td border="1" width="50%" align="left">  Market Coverage</td>
			   <td border="1" width="25%">' . number_format($sup['NP_PARA_1_MKT_COV_PRINT']) . '</td>
               <td border="1" width="25%">' . number_format($sup['NP_PARA_1_MKT_COV_PCT']) . '</td>
            </tr>
            <tr>
			   <td border="1" width="50%" align="left">  Nonpaid Bulk</td>
			   <td border="1" width="25%">' . number_format($sup['NP_PARA_1_BULK_PRINT']) . '</td>
               <td border="1" width="25%">' . number_format($sup['NP_PARA_1_BULK_PCT']) . '</td>
            </tr>
            <tr>
               <td border="1" width="50%" align="left">  Delivered with Host Product</td>
               <td border="1" width="25%">' . number_format($sup['NP_PARA_1_DEL_HOST_PROD_PRINT']) . '</td>
               <td border="1" width="25%">' . number_format($sup['NP_PARA_1_DEL_HOST_PROD_PCT']) . '</td>
            </tr>
            <tr>
			   <td border="1" width="50%" align="left"><b>  Total Analyzed Nonpaid</b></td>
			   <td border="1" width="25%"><b>' . number_format($sup['NP_PARA_1_TOTAL_ANP_PRINT']) . '</b></td>
               <td border="1" width="25%"><b>' . number_format($sup['NP_PARA_1_TOTAL_ANP_PCT']) . '</b></td>
            </tr> ';
...
$Supplemental_Analysis = 
    '<table align="center" width="100%">
            <thead>
                <tr>
                    <td width="50%"></td>
                    <td border="1" width="25%" style="background-color: #bcd4ee;"><b>Print</b></td>
                    <td border="1" width="25%" style="background-color: #bcd4ee;"><b>% of Circulation</b></td>
                </tr>
            </thead>    
            <tbody>
                <tr>
...
if($var){
    ...
    foreach($var as $row) {            
        $data .= '<tr>
                ...
                <td width="17%">' .check($row['RATE_BASE']). '</td>
    ...
    '<table align="center" width="100%" border="1">
                <thead>
                    <tr style="background-color: #bcd4ee;">
                        ...
                        <td width="16%"><b>Percentage of Difference</b></td>				        
                    </tr>                     			 
				</thead>' . $data . '
    </table>';           
